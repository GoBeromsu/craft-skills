...
1. ~~eval 캠페인~~ **완료(2026-07-12)**: 1,520케이스 실측, 20영수증 커밋. 잔여 신호는 [campaign-summary.md](receipts/campaign-summary.md) — 행동 판정 42건은 기대치 저작 스타일 이슈(후속 스크래치 규율), git behavior-03은 후속 후보 1건.
