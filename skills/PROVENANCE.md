...
| `frontend` | incumbent-aware framework shell, slice/public API, component/state, CSS/measurement rules, and material-design handoff without a universal design gate | code-yeongyu/lazycodex (MIT; pattern-only); official sources retrieved 2026-08-29: [React](https://react.dev/), [Next.js](https://nextjs.org/docs), [Vite](https://vite.dev/guide/), [FSD](https://fsd.how/docs/), [MDN CSS](https://developer.mozilla.org/en-US/docs/Web/CSS/), [web.dev performance](https://web.dev/learn/performance/) | adapted |
