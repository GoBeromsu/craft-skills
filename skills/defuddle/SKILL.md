...
- The `init` skill's tool-preflight reference (`tool-preflight.md` under its references) records the installed Defuddle probe, release evidence, support boundary, and CHANGELOG verification receipt convention.
