...
- 2026-07-12 — v1.0.0: ported the Defuddle web-extraction skill into craft-skills → clean-Markdown/JSON extraction workflow, the fetch-and-strip anti-pattern guard, the 8-field JSON contract, and the scrapling fallback chain; dropped vault-ingest coupling and personal-domain source notes. Provenance: bstack defuddle.
