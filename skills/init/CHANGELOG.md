...
- 2026-09-03 — v4.1.2: the install scanner classified a nested-file rationale as a configuration modification → phrase the rationale descriptively and add eval coverage.
